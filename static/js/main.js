      ...
      $(document).ready(function () {
        ...
        function triggerOdometer(element) {
          ...
          if (!$element.hasClass('odometer-triggered')) {
            // Get the count value as a string to preserve leading zeros
            const countNumber = $element.attr('data-count').toString();
            // Use text() instead of html() to prevent any HTML parsing issues
            $element.text(countNumber);
